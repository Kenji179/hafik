...
$email .=				'<strong>Přihláška pro přijetí dítěte na hlídání v centru Hafík</strong><br>';
$email .=			'Provozovna: Štefánikova 102/7, Kutná Hora';
$email .=			'</p>';
...
$email .=				'</table>';
$email .=			'<p>';
$email .=				'na hlídání v centru Hafík, v provozovně Štefánikova 102/7, 284 01 Kutná Hora (dále také jen „Centrum Hafík“)';
$email .=			'</p>';
$email .=			'<p>';
...
$email .=			'<p>';
$email .=				'<ul>';
$email .=				'<li>Prohlašuji, že jsem se seznámil/a s Ceníkem za poskytované služby a Provozním řádem Centra Hafík, ve kterém jsou uvedeny veškeré podrobnosti týkající se hlídací služby, a tento se zavazuji respektovat.</li>';
